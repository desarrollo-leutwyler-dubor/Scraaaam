        ...
        describe("Inside project", () => {
            ...
            it("comment a task", async () => {
                ...
                const cantidadDeCommentsOriginal = await element.all(
                    by.css("taskframe commentlist div[class='collapse in'] comment")
                ).count()
                await element(
                    by.css("taskframe commentlist div[class='collapse in'] form textarea")
                ).sendKeys("protractor comment")
                await element(
                    by.css("taskframe commentlist div[class='collapse in'] form button")
                ).click()
                const cantidadActual = await element.all(
                    by.css("taskframe commentlist div[class='collapse in'] comment")
                ).count()
